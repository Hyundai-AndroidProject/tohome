...
@Database(entities = [Store::class, Waiting::class, Reservation::class],version = 1)
...
private val STORE_DATA = arrayListOf(
    ...
    Store(6,"송(6F)","30년간 한결같은 맛으로 자리를 지켜온 일본식 우동&메밀 전문점입니다.","https://user-images.githubusercontent.com/52660729/205539946-8f1e67f6-b457-4a18-a301-3803a9344525.jpg","목동"),
